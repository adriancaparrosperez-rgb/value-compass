...
def _safe_exception_details(
    ...
    """
    Devuelve metadatos técnicos serializables sin exponer
    un traceback completo en el snapshot.
    """
...
def _available_keys(
    ...
    """
    Obtiene claves públicas de forma defensiva para diagnóstico.
    """
    keys: list[str] = []
